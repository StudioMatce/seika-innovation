...
- ✅ Componenti: Container, Header (desktop), HeaderMobile (overlay), Hero, ShowCase, ProgressBar, Servizi, SeikaInnovation (chi siamo), Metodo
- ⏳ Da fare: ShowCase loghi, Prioritizzazione, Risultati, CaseStudy, Manifesto, FAQ, CTA finale, Footer
